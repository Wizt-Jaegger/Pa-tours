...
import modelo6 from '../../assets/camioneta6.png';
...
const ModelosCamionetas = () => {
    const modelos = [
        ...
        { id: 2, img: modelo6, nombre: "Modelo 6 Personas", caracteristicas: ["Amplia capacidad de equipaje", "Sistema de video", "Seguro de viajero", "Chofer capacitado"] },
        ...
        { id: 7, img: modelo1, nombre: "Modelo Ejecutivo", caracteristicas: ["Seguro de viajero", "Aire acondicionado", "Sistema de audio", "Chofer capacitado"] },
    ];    
